            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mb-4">
                  ...
                  {productData.rating.rate >= 2 && productData.rating.rate < 3 && (
                    <span className="flex items-center">
                      <svg
                        fill="currentColor"
                        stroke="currentColor"
                  ...
                  {productData.rating.rate >= 3 && productData.rating.rate < 4 && (
                    <span className="flex items-center">
                      <svg
                        fill="currentColor"
                        stroke="currentColor"
                  ...
                  {productData.rating.rate >= 4 && productData.rating.rate < 5 && (
                    <span className="flex items-center">
                      <svg
                        fill="currentColor"
                        stroke="currentColor"
